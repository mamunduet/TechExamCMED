<%--
    ...
    Created on : Dec 1, 2018, 12:40:18 PM
    Author     : mamun
--%>
...
<html lang="en">
    <head>
        <title>Prescription | Edit Prescription</title>
                            ...
                            <div class="page-content">
                                <div class="container">
                                    <ul class="page-breadcrumb breadcrumb">
                                        ...
                                        <li>
                                            <span id="features" data-class-active=".common .appConstants .addAppConstants">Edit Prescription</span>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="tab-content" style="padding-top: 15px;">
                                                        <div class="portlet box green">
                                                            <div class="portlet-title">
                                                                <div class="caption">
                                                                    <i class="fa fa-plus"></i> Edit Prescription Info </div>
                                                                <div class="tools">
                                                                    <a href="javascript:;" class="collapse"> </a>
                                                                </div>
                                                            </div>
                                                            <div class="portlet-body form">
                                                                <html:form action="updatePrescriptionInfo" styleClass="form-horizontal" method="POST"  acceptCharset="UTF-8">
                                                                    <%@include file="prescriptionTable.jsp" %>
                                                                    <div class="form-actions">
                                                                        <div class="row">
                                                                            <div class="col-md-offset-3 col-md-4">
                                                                                <button id="validateInput" type="submit" type="submit" class="btn green" name="saveButton">Submit</button>
